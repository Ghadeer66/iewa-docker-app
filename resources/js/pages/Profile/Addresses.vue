            ...
            <div class="flex-1">
                <div class="bg-white rounded-xl shadow p-6">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <button class="bg-[#4e3356] text-white px-4 py-2 rounded-lg hover:bg-[#6b4781] transition">
                            افزودن آدرس جدید
                        </button>
                    </div>
                    ...
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-xl font-bold text-gray-700 mb-2">هنوز آدرسی ثبت نکرده‌اید</h3>
                        <p class="text-gray-500 mb-6">با افزودن آدرس، فرآیند سفارش‌دهی سریع‌تر خواهد بود</p>
                        <button
