        ...
        <div class="flex flex-col md:flex-row gap-6 container mx-auto px-6 mt-6 mb-12">
            ...
            <div class="flex-1">
                <div class="bg-white rounded-xl shadow p-6">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6">تاریخچه تراکنش ها</h2>
                    ...
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-xl font-bold text-gray-700 mb-2">هیچ تراکنشی ثبت نشده است</h3>
                        <p class="text-gray-500">پس از انجام اولین تراکنش، تاریخچه آن در اینجا نمایش داده می‌شود</p>
                    </div>
                </div>
            </div>
        </div>
