        ...
        <div class="flex flex-col md:flex-row gap-6 container mx-auto px-6 mt-6 mb-12">
            ...
            <aside class="w-full md:w-1/4 bg-white shadow rounded-xl p-4">
                ...
                <ul class="space-y-2 text-gray-700 text-sm">
                    ...
                    <li class="flex items-center gap-3 cursor-pointer hover:bg-gray-100 p-2 rounded" @click="goTo('comments')">
                        <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="flex-1">
                <div class="bg-white rounded-xl shadow p-6">
                    ...
                    <!-- Transaction History -->
                    <h3 class="text-lg font-bold text-gray-800 mb-4">تاریخچه تراکنش‌ها</h3>
                        ...
                        >
                            <div>
                                ...
                                <p class="text-sm text-gray-500">
                                    ...
                                    <span v-if="tx.receiver"> — دریافت‌کننده: {{ tx.receiver.name }}</span>
                                </p>
                            </div>
                            <p :class="tx.type === 'deposit' ? 'text-green-600' : 'text-red-600'">
                                {{ tx.type === 'deposit' ? '+' : '-' }}{{ tx.amount.toLocaleString() }} تومان
                            </p>
                        </div>
                    </div>
