        ...
        <div class="flex flex-col md:flex-row gap-6 container mx-auto px-6 mt-6 mb-12">
            ...
            <div class="flex-1 flex flex-col gap-6">
                ...
                <div class="bg-white rounded-xl shadow p-6 flex flex-col items-center">
                    ...
                    <div class="mt-4 w-full flex justify-between bg-yellow-50 rounded p-2">
...
// Colors for BMI visualization
const bmiColors = ['#3b82f6', '#10b981', '#facc15', '#f97316', '#ef4444']
...
<style scoped>
/* optional scrollbar hiding for sidebar */
::-webkit-scrollbar {
    display: none;
}
</style>
