  ...
  <section class="container mx-auto px-6 py-6">
    ...
    <div class="flex gap-6 flex-nowrap">
      ...
      >
        ...
        <div
          class="w-full bg-gray-100 rounded-xl p-3 flex flex-col items-center text-center shadow-sm hover:shadow-md transition"
        >
          <div class="w-15 h-15 mt-4 bg-white rounded-full flex items-center justify-center flex-shrink-0">
            <img :src="cat.image" :alt="cat.title" class="w-20 h-2s0 object-contain" />
          </div>
