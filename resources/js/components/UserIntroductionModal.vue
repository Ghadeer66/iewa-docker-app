<template>
    <Transition name="modal">
        <div v-if="showModal"
            ...
            <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-11/12 max-h-[85vh] overflow-y-auto p-8 relative transform transition-all"
                dir="rtl">
                <!-- Close Button -->
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-blue-50 rounded-lg p-6 border-r-4 border-blue-500">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            در صفحه محصولات، می‌توانید از دکمه‌های منو برای دسته‌بندی محصولات استفاده کنید:
                        </p>
                        <ul class="mt-3 space-y-2 text-gray-700 list-disc list-inside">
                            <li><strong>همه:</strong> نمایش تمام محصولات.</li>
                            <li><strong>لاین غذای اقتصادی:</strong> غذاهای اقتصادی سلامت محور.</li>
                            <li><strong>پک میانوعده:</strong> پکیج‌های تغذیه سالم میانوعده.</li>
                        ...
                        <div class="mt-3 bg-white rounded p-4 border border-green-200">
                            <div class="flex items-start justify-between gap-4">
                                <div class="flex-1 text-right">
                                    <p class="text-gray-700 font-medium mb-2">این عدد نشانگر:</p>
                                    <p class="text-gray-700">
                                        <strong>تعداد همکاران شرکت شما که در این روز محصولی را خریداری کرده‌اند.</strong>
                                    </p>
                                    <i><p class="text-sm text-gray-900 mt-2">
                                        برای مثال، اگر عدد ۲۵ نمایش داده شود، یعنی ۲۵ کاربر از شرکت شما در این روز محصولی را خریداری کرده‌اند.
                                    </p></i>
                                </div>
                                <div class="shrink-0">
                                    <img src="/images/day-center.png" alt="روز - مرکز" class="w-38 h-auto mt-5" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-purple-50 rounded-lg p-6 border-r-4 border-purple-500">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="bg-white rounded p-4 border border-purple-200">
                                <h4 class="font-bold text-red-600 mb-2">خرید روزانه (انتخاب ۱ یا ۲ روز)</h4>
                                <p class="text-sm text-gray-700">
                                    با انتخاب ۱ یا ۲ روز،  تخفیف و سوبسید  به خرید شما تعلق نمی‌گیرد.
                                </p>
                            </div>
                            ...
                            <div class="bg-white rounded p-4 border border-purple-200">
                                ...
                                <p class="text-sm text-gray-700">
                                    با انتخاب ۳ روز یا بیشتر، <strong>۲۰٪ تخفیف</strong> و <strong>سوبسید شرکت</strong>  به خرید شما تعلق می‌گیرد.
                                </p>
                            </div>
                            ...
                            <div class="bg-white rounded p-4 border border-purple-200">
                                <h4 class="font-bold text-purple-600 mb-2">
                                    خرید ماهانه (حداقل ۸ روز در ۴ هفته متوالی)
                                </h4>
                                <p class="text-sm text-gray-700">
                                    با انتخاب ۸ روز یا بیشتر،  <strong>۴۰٪ تخفیف</strong> و <strong>سوبسید شرکت</strong>  به خرید شما تعلق می‌گیرد.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 bg-white rounded p-4 border border-purple-200">
                            ...
                            قیمت مصرف‌کننده - سوبسید شرکت - تخفیف پلن (هفتگی/ ماهانه) + هزینه ارسال
                        </div>
                    </div>
                </div>
...
const STORAGE_KEY = `menu_intro_seen_${user?.id}`
